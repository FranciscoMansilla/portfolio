...
const projects = [
  {
    ...
    description: "This is a simple console application written in Go that allows you to perform CRUD operations (Create, Read, Update, Delete) on user records.",
    color: "blue",
    tag: "Go",
  },
  {
    ...
    description: "Chatbot of restaurant connected to the api of meta that response messages through on whatsapp",
    color: "green",
    tag: "python",
  },
  {
    ...
    page: "",
    name: "To do list",
    description: "Little To do list window app in java",
    color: "red",
    tag: "java",
  },
  {
    ...
    description: "Sync-a is a personal project of multi-e-commerce",
    color: "yellow",
    tag: "javascript",
  },
  {

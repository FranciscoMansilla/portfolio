import img from '../../assets/fran.png'

const Carrousel = ()=>{
    return(
    
<div id="indicators-carousel" className="relative" data-carousel-slide-to="1">
    {/* <!-- Carousel wrapper --> */}
    <div className="overflow-hidden relative h-48 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
        ...
        <div className="duration-700 ease-in-out absolute inset-0 transition-all transform translate-x-0 z-20" data-carousel-item="1">
            <img src={img} className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
        </div>
        {/* <!-- Item 2 --> */}
    ...
    {/* <!-- Slider controls --> */}
    <button type="button" className="flex absolute top-0 left-0 z-30 justify-center items-center px-4 h-full cursor-pointer group focus:outline-none" data-carousel-prev="1">
